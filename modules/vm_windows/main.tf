...
resource "azurerm_public_ip" "publicip" {
  ...
  sku                     = "Standard"
  domain_name_label       = "${var.dns}-${count.index + 1}"
...
resource "azurerm_windows_virtual_machine" "vm" {
  ...
  source_image_id       = "/subscriptions/521eff37-ed04-4486-9f3f-39c56c44bdf9/resourceGroups/finops-demo/providers/Microsoft.Compute/images/AMI-w2k19-default1"
